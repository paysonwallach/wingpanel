...
public class Wingpanel.Services.IndicatorSorter : Object {
    ...
    static construct {
        ...
        indicator_order[Indicator.PRINTER] = 5;
        indicator_order[Indicator.SYNC] = 6;
        indicator_order[Indicator.SOUND] = 7;
        indicator_order[Indicator.NETWORK] = 8;
        indicator_order[Indicator.BLUETOOTH] = 9;
        indicator_order[Indicator.KEYBOARD] = 10;
        indicator_order[Indicator.POWER] = 11;
        indicator_order[Indicator.DATETIME] = 12;
        indicator_order[Indicator.SESSION] = 13;
        indicator_order[Indicator.MESSAGES] = 14;
    }
